              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white" id="exampleModalLabel">Add New Members</h5>
                  ...
                  <div class="modal-body">
                    <form method="post" action="" enctype="multipart/form-data" class="form-valide">
                      <div class="form-group">
                        <label for="firstName" class="col-form-label font-weight-bold text-dark">Member Type</label>
                        <input type="text" id="firstName" name="txtmembertype" placeholder="Member Type" class="form-control" required />
