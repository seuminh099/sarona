                	...
                	<table cellpadding="5px" cellspacing="0" align="center" border="1px" class="table table-hover font-weight-bolder">
                        ...
                        ?>
                			<tr >
                				...
                				<td>
                                    <a href="supplierrestorecode.php?SupplierID=<?php echo $supplierid;?>" 
                                           class="btn btn-primary" id="delete">Restore <i class="fas fa-trash-restore"></i></a>
                                </td>
                				<td>
                                    <a href="supplierdeleterestore.php?SupplierID=<?php echo $supplierid;?>" 
